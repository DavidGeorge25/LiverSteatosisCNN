...
def _repo_root() -> Path:
    ...
    Not a fixed number of parents: this module moved deeper in the tree during
    the restructure, and hardcoding the depth is what would silently start
    reporting "not a git repository" instead of the commit that made a figure.
    """
